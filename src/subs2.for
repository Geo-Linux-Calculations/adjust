...
C      SCCSID='$Id: subs2.for 115800 2020-05-14 06:20:00Z michael.dennis $	20$Date: 2008/10/27 17:18:38 $ NGS'
...
*** GPS GFILE CODE '35' NAD83 (PA11) TO NAD83(2011)
      ...
      RX(35)    = (00.00000000D0 + (0.00000000D0 * (T - 1997.0D0))) * AM
      COSRX(35) = DCOS(RX(35))
      SINRX(35) = DSIN(RX(35))
...
*** GPS GFILE CODE '36' NAD83 (MA11) TO NAD83(2011)
      ...
      RX(36)    = (00.00000000D0 + (0.00000000D0 * (T - 1997.0D0))) * AM
      COSRX(36) = DCOS(RX(36))
      SINRX(36) = DSIN(RX(36))
